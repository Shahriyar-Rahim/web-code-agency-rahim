...
const Pricing = () => {
  ...
  return (
    <div className="section-container">
        <HeadingSection heading="choose your plan" subheading="pricing" description="Our pricing plans are flexible and designed to fit your needs. Choose your plan and start creating today!" />

        {/* toggle button for yearly/monthly plan*/}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
            {
                pricingPlans.map((plan) => (
                    <div key={plan.name} className="bg-white hover:border rounded-lg overflow-hidden transition-all duration-300 hover:shadow-xl">
                        ...
                        <div className="p-5 text-center">
                            ...
                            <p className="mt-5 transition duration-200">{isYearly ? plan.saves : ""}</p>
                        </div>

                        {/* buttton */}
                        <div className="p-5 text-center">
                            <button className="bg-blue-600 text-white px-6 py-2 rounded-full hover:bg-blue-800 transition duration-300">Choose {plan.name}</button>
                        </div>
