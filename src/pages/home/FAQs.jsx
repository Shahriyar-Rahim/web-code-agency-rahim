...
const FAQs = () => {
    ...
    // toggle button to visible answer
    const toggleFAQ = (id) => {
        if(expandedFAQ === id) {
            setExpandedFAQ(null)
        } else {
        ...
        <div className='section-container'>
            ...
            <div className='w-full max-w-4xl mx-auto'>
                {faqs.map((faq) => (
                    ...
                    '>
                        {/* faq questions */}
                        <div className='flex justify-between items-center p-4 bg-gray-50 hover:bg-gray-200 transition duration-300 cursor-pointer' onClick={() => toggleFAQ(faq.id)}>
