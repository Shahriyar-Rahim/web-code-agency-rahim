...
const NavBar = () => {
    ...
    return (
        <div className="navbar max-w-screen-2xl container mx-auto bg-white text-black px-5 shadow-sm">
            ...
            <div className="navbar-end space-x-4">

                {
                    ...
                    <button onClick={handleLogout} className="btn btn-primary bg-[#0F62FE] text-white">Log Out</button>
                    </>
                    ) : (
                    <><Link to="/login" className="btn btn-outline btn-primary px-8 hidden sm:flex">Log In</Link>
                            <Link to="/pricing" className="btn btn-primary bg-[#0F62FE] text-white">Start Free Trial</Link></>
                        )
                }
